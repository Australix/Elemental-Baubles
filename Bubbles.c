...
*/
	...
	//normal bubbles
		...
		//In very late levels this is not implemented to boost difficulty.
		for(i=0;i<8;i++){
			for(k=0;k<8;k++){
		...
		//if there's only one type of bubble on-screen, then we ensure
		...
		//essentially, we end up with 3 levels of difficulty after all this
		if(Level>7){
